 ...
 *
 */
export interface IconTextSliceDefaultItem {
    /**
     * IconName field in *IconText → Items*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
     * - **API ID Path**: icon_text.items[].iconname
     * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
     *
     */
    iconname: prismicT.KeyTextField;
    /**
     * Heading field in *IconText → Items*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
     * - **API ID Path**: icon_text.items[].heading
     * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
     *
     */
    heading: prismicT.KeyTextField;
    /**
     * Description field in *IconText → Items*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: icon_text.items[].description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
...
/**
 * Default variation for IconText Slice
 *
 * - **API ID**: `default`
 ...
 *
 */
export type IconTextSliceDefault = prismicT.SharedSliceVariation<"default", Record<string, never>, Simplify<IconTextSliceDefaultItem>>;
/**
 * Slice variation for *IconText*
 *
 */
type IconTextSliceVariation = IconTextSliceDefault;
/**
 * IconText Shared Slice
 *
 * - **API ID**: `icon_text`
 * - **Description**: `IconText`
 * - **Documentation**: https://prismic.io/docs/core-concepts/reusing-slices
 *
 */
export type IconTextSlice = prismicT.SharedSlice<"icon_text", IconTextSliceVariation>;
/**
...
interface VideoSliceDefaultPrimary {
    ...
    title: prismicT.TitleField;
    /**
     * Description field in *Video → Primary*
     *
     * - **Field Type**: Rich Text
     * - **Placeholder**: A nice description of your feature
     * - **API ID Path**: video.primary.description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
    ...
    /**
     * Button field in *Video → Primary*
     *
     * - **Field Type**: Link
     * - **Placeholder**: *None*
     * - **API ID Path**: video.primary.button
     * - **Documentation**: https://prismic.io/docs/core-concepts/link-content-relationship
     *
     */
    button: prismicT.LinkField;
    /**
     * Button Text field in *Video → Primary*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
     * - **API ID Path**: video.primary.button_text
     * - **Documentation**: https://prismic.io/docs/core-concepts/key-text
     *
     */
